...
public class BatManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //      and so on.
        float[] _newTextTimers = new float[_bats.Length];
        // STEP 6 -------------------------------------------------------------
    }
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < _newTextTimers.Length;)
        {
    ...
    private void CreateReactions(BatW6 bat)
    {
        ...
        int randNum = Random.Range(0, _messages.Length);

        SpawnReactionUI(bat, _messages[randNum]);
